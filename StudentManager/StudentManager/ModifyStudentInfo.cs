...
namespace StudentManager
{
    public partial class modifystuForm : Form
    {
        ...
        {
            InitializeComponent();
            comboBoxmajor.SelectedIndex = comboBoxmajor.Items.IndexOf("计算机科学与技术");
            comboBoxgrade.SelectedIndex = comboBoxgrade.Items.IndexOf("大一");
        }
        ...
        {
            textBoxname.Text = dataGridView1.SelectedRows[0].Cells[1].Value.ToString().Trim();
            textBoxborn.Text = dataGridView1.SelectedRows[0].Cells[7].Value.ToString().Trim();
            comboBoxgrade.Text = dataGridView1.SelectedRows[0].Cells[4].Value.ToString().Trim();
            textBoxhometown.Text = dataGridView1.SelectedRows[0].Cells[8].Value.ToString().Trim();
            comboBoxmajor.Text = dataGridView1.SelectedRows[0].Cells[5].Value.ToString().Trim();
            textBoxpasswd.Text = dataGridView1.SelectedRows[0].Cells[3].Value.ToString().Trim();
            textBoxpname.Text = dataGridView1.SelectedRows[0].Cells[2].Value.ToString().Trim();
            textBoxid.Text = dataGridView1.SelectedRows[0].Cells[0].Value.ToString().Trim();
            string gender = dataGridView1.SelectedRows[0].Cells[6].Value.ToString().Trim();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string major = comboBoxmajor.SelectedItem.ToString().Trim();
            string grade = comboBoxgrade.SelectedItem.ToString().Trim();
